...
void GUI::UpdateStats(std::vector<AIPlayer*>* players, short mouseX, short mouseY)
{
	m_endOfGameMenuView = false;
	m_gameGUIView = true;
...
void GUI::UpdateStats(std::vector<AIPlayer*>* players, short mouseX, short mouseY, bool & playAgain, bool & exit, bool & enterMenu)
{
