...
public:
	...
	void UpdateStats(std::vector<AIPlayer*> * players, short mouseX, short mouseY);
	void UpdateStats(std::vector<AIPlayer*> * players, short mouseX, short mouseY, bool & playAgain, bool & exit, bool & enterMenu);
